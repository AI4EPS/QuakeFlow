...
if __name__ == "__main__":
    ...
    data_path = root_path / "phasenet"
    result_path = root_path / "gamma"
    if not result_path.exists():
        result_path.mkdir()

    # station_csv = data_path / "stations.csv"
    station_json = root_path/ "obspy" / "stations.json"
    pick_csv = data_path / "picks.csv"
    catalog_csv = result_path / "gamma_catalog.csv"
    picks_csv = result_path / "gamma_picks.csv"
