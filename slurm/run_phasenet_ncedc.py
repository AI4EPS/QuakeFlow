...
if __name__ == "__main__":
    ...
    def run_pipeline(root_path: str, region: str, config: Dict, token: Dict = None):
        mseed_op = get_mseed_list(root_path=root_path, region=region, config=config, year=year, token=token)
    ...
    client = Client("https://732859323117dcc5-dot-us-west1.pipelines.googleusercontent.com")
