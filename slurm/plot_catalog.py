...
# %%
growclust_file = result_path / "growclust_ct_catalog.txt"
...
# %%
growclust_file = result_path / "growclust_cc_catalog.txt"
...
if growclust_ct_exist:
    ...
    ax[3, 1].set_title(f"GrowClust (CC): {len(growclust_ct_catalog)}")
...
if growclust_cc_exist:
    ...
    ax[4, 1].set_title(f"GrowClust (CT): {len(growclust_cc_catalog)}")
