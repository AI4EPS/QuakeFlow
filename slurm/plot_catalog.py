...
ax[1, 0].scatter(catalog_hypodd_ct["LON"], catalog_hypodd_ct["LAT"], s=800/len(catalog_hypodd_ct), alpha=1.0, linewidth=0)
ax[1, 0].set_title(f"HypoDD (CT): {len(catalog_hypodd_ct)}")
ax[1, 0].set_xlim(xlim)
ax[1, 0].set_ylim(ylim)
ax[1, 1].scatter(catalog_hypodd_cc["LON"], catalog_hypodd_cc["LAT"], s=800/len(catalog_hypodd_cc), alpha=1.0, linewidth=0)
