...
ax[0, 1].scatter(growclust_catalog["lonR"], growclust_catalog["latR"], s=800/len(growclust_catalog), alpha=1.0, linewidth=0)
ax[0, 1].set_title(f"GrowClust: {len(growclust_catalog)}")
ax[0, 1].set_xlim(xlim)
ax[0, 1].set_ylim(ylim)
ax[1, 0].scatter(catalog_hypodd_ct["LON"], catalog_hypodd_ct["LAT"], s=500/len(catalog_hypodd_ct), alpha=1.0, linewidth=0)
ax[1, 0].set_title(f"HypoDD (CT): {len(catalog_hypodd_ct)}")
ax[1, 0].set_xlim(xlim)
ax[1, 0].set_ylim(ylim)
ax[1, 1].scatter(catalog_hypodd_cc["LON"], catalog_hypodd_cc["LAT"], s=500/len(catalog_hypodd_cc), alpha=1.0, linewidth=0)
ax[1, 1].set_title(f"HypoDD (CC): {len(catalog_hypodd_cc)}")
